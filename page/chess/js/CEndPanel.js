function CEndPanel(oSpriteBg) {
    ...
    this._init = function(oSpriteBg) {
        ...
        _oMsgText = new CTLText(_oGroup, iX - iWidth / 2, iY - iHeight / 2, iWidth, iHeight, 90, "center", "#ffffff", PRIMARY_FONT, 1, 2, 2, "", true, true, false, false);
        var iWidth = oSpriteBg.width - 320;
        var iHeight = 50;
        var iX = CANVAS_WIDTH / 2;
        var iY = CANVAS_HEIGHT / 2 - 230;
        _oMsgTextUnder = new CTLText(_oGroup, iX - iWidth / 2, iY - iHeight / 2, iWidth, iHeight, 40, "center", "#ffffff", PRIMARY_FONT, 1, 2, 2, "", true, true, false, false);
