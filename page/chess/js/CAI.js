    ...
    this._makeMove = function(oMove) {
        ...
        switch (oMove.special) {
            case BOARD_SPECIAL_CASTLING_RIGHT:
                {
                    _aCurBoard[oMove.sourcerow][5] = {
                        color: oMove.sourcecolor,
                        type: ROOK,
                        history: _aCurBoard[oMove.sourcerow][7].history
                    };_aCurBoard[oMove.sourcerow][7] = {
                        color: null,
                        type: null,
                        history: []
                    };
            ...
            case BOARD_SPECIAL_CASTLING_LEFT:
                {
                    _aCurBoard[oMove.sourcerow][3] = {
                        color: oMove.sourcecolor,
                        type: ROOK,
                        history: _aCurBoard[oMove.sourcerow][0].history
                    };_aCurBoard[oMove.sourcerow][0] = {
                        color: null,
                        type: null,
                        history: []
                    };
            ...
            case BOARD_SPECIAL_ENPASSANT:
                {
                    var szOpponentColor = s_oBoardStateController.getOtherOpponent(oMove.sourcecolor);_aCurBoard[oMove.sourcerow][oMove.destcol] = {
                        color: null,
                        type: null,
                        history: []
            ...
            case BOARD_SPECIAL_CASTLING_RIGHT:
                {
                    _aCurBoard[oMove.sourcerow][7] = {
                        color: oMove.sourcecolor,
                        type: ROOK,
                        history: _aCurBoard[oMove.sourcerow][5].history
                    };_aCurBoard[oMove.sourcerow][5] = {
                        color: null,
                        type: null,
                        history: []
            ...
            case BOARD_SPECIAL_CASTLING_LEFT:
                {
                    _aCurBoard[oMove.sourcerow][0] = {
                        color: oMove.sourcecolor,
                        type: ROOK,
                        history: _aCurBoard[oMove.sourcerow][3].history
                    };_aCurBoard[oMove.sourcerow][3] = {
                        color: null,
                        type: null,
                        history: []
