function CAreYouSurePanel(oFunction) {
    ...
    this._init = function(oFunction) {
        ...
        var iX = 0;
        var iY = -240;
        var oTitle = new CTLText(_oPanelContainer, iX - iWidth / 2, iY - iHeight / 2, iWidth, iHeight, 100, "center", "#ffffff", PRIMARY_FONT, 1, 2, 2, TEXT_ARE_SURE, true, true, true, false);
