            ...
            case BOARD_SPECIAL_CASTLING_RIGHT:
                {
                    ...
                    var oRookDestCell = aCopiedBoard[iStartRow][5];oRookDestCell.setCell(oStartCopiedCell.getColor(), ROOK, iDestRow, iDestCol, oStartCopiedCell.getPieceHistory());oRookStartCell.setCell(null, null, iStartRow, iStartCol, []);
                    break;
                }
            case BOARD_SPECIAL_CASTLING_LEFT:
                {
                    var oRookStartCell = aCopiedBoard[iStartRow][0];
                    var oRookDestCell = aCopiedBoard[iStartRow][3];oRookDestCell.setCell(oStartCopiedCell.getColor(), ROOK, iDestRow, iDestCol, oStartCopiedCell.getPieceHistory());oRookStartCell.setCell(null, null, iStartRow, iStartCol, []);
                    break;
                }
            case BOARD_SPECIAL_ENPASSANT:
                {
                    var oPawnToPassCell = aCopiedBoard[iStartRow][iDestCol];oPawnToPassCell.setCell(null, null, iStartRow, iDestCol, []);
                    break;
                }
        }
