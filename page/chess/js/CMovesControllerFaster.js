    ...
    this._makeMove = function(aBoard, oMove) {
        switch (oMove.special) {
            case BOARD_SPECIAL_CASTLING_RIGHT:
                {
                    aBoard[oMove.sourcerow][5] = {
                        color: oMove.sourcecolor,
                        type: ROOK,
                        history: aBoard[oMove.sourcerow][7].history
                    };aBoard[oMove.sourcerow][7] = {
                        color: null,
                        type: null,
                        history: []
                    };
            ...
            case BOARD_SPECIAL_CASTLING_LEFT:
                {
                    aBoard[oMove.sourcerow][3] = {
                        color: oMove.sourcecolor,
                        type: ROOK,
                        history: aBoard[oMove.sourcerow][0].history
                    };aBoard[oMove.sourcerow][0] = {
                        color: null,
                        type: null,
                        history: []
                    };
            ...
            case BOARD_SPECIAL_ENPASSANT:
                {
                    var szOpponentColor = s_oBoardStateController.getOtherOpponent(oMove.sourcecolor);aBoard[oMove.sourcerow][oMove.destcol] = {
                        color: null,
                        type: null,
                        history: []
                    };
            ...
            case BOARD_SPECIAL_CASTLING_RIGHT:
                {
                    aBoard[oMove.sourcerow][7] = {
                        color: oMove.sourcecolor,
                        type: ROOK,
                        history: aBoard[oMove.sourcerow][5].history
                    };aBoard[oMove.sourcerow][5] = {
                        color: null,
                        type: null,
                        history: []
            ...
            case BOARD_SPECIAL_CASTLING_LEFT:
                {
                    aBoard[oMove.sourcerow][0] = {
                        color: oMove.sourcecolor,
                        type: ROOK,
                        history: aBoard[oMove.sourcerow][3].history
                    };aBoard[oMove.sourcerow][3] = {
                        color: null,
                        type: null,
                        history: []
