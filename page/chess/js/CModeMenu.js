function CModeMenu() {
    ...
    this._init = function() {
        ...
        var iY = 400;
        var oTitle = new CTLText(s_oStage, iX - iWidth / 2, iY - iHeight / 2, iWidth, iHeight, 80, "center", "#ffffff", PRIMARY_FONT, 1, 2, 2, TEXT_MODE, true, true, true, false);
    ...
    this._onDifficultyToggle = function(iMode) {
        switch (iMode) {
            case EASY_MODE:
                {
                    _oToggleEasy.setActive(true);_oToggleMedium.setActive(false);_oToggleHard.setActive(false);_iModeSelected = EASY_MODE;SEARCH_DEPTH = 1;
                    break;
                }
            case MEDIUM_MODE:
                {
                    _oToggleEasy.setActive(false);_oToggleMedium.setActive(true);_oToggleHard.setActive(false);_iModeSelected = MEDIUM_MODE;SEARCH_DEPTH = 2;
                    break;
                }
            case HARD_MODE:
                {
                    _oToggleEasy.setActive(false);_oToggleMedium.setActive(false);_oToggleHard.setActive(true);_iModeSelected = HARD_MODE;SEARCH_DEPTH = 3;
                    break;
                }
        }
    };
